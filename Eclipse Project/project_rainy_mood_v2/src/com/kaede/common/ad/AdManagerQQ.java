...
public class AdManagerQQ {
	...
	public static void loadIntertistial(final Activity activity) {
		...
		final InterstitialAd iad = new InterstitialAd(activity, APPId, InterteristalId);
	...
	public static void loadIntertistial(final Activity activity, final CommonCallback<Integer> listener) {
